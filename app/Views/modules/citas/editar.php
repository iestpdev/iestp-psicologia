                    ...
                    <form action="<?= base_url('api/citas/update/' . $cita['id']) ?>" method="POST">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="tipo_derivacion" id="tipo_derivacion" class="form-control-custom"
                                        required>
                                        <option value="AUTONOMO" <?= $cita['tipo_derivacion'] === 'AUTONOMO' ? 'selected' : '' ?>>Autónomo</option>
                                        <option value="DOCENTE" <?= $cita['tipo_derivacion'] === 'DOCENTE' ? 'selected' : '' ?>>Docente</option>
                                        <option value="FAMILIAR" <?= $cita['tipo_derivacion'] === 'FAMILIAR' ? 'selected' : '' ?>>Familiar</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <fieldset id="detallesCitaFieldset" class="fieldset">
                            ...
                            foreach ($textareas as $name => $label):
                                $valor = isset($detalleCita[$name]) ? esc($detalleCita[$name]) : '';
                                ?>
                                <div class="textarea-wrapper">
                                    <label class="textarea-label"><?= $label ?></label>
                                    <textarea name="<?= $name ?>" class="auto-expand-textarea"
                                        placeholder="Detalle <?= strtolower($label) ?>..."
                                        maxlength="500"><?= $valor ?></textarea>
                                    <div class="character-count"><?= strlen($valor) ?>/500</div>
                                </div>
                            <?php endforeach; ?>
                        </fieldset>
