                    ...
                    data-icon="question">
                                        ...
                                        <select id="alumnoSelect" name="alumno" required>
                                            ...
                                            <?php foreach ($alumnos as $alumno): ?>
                                                <option value="<?= $alumno['id'] ?>"
                                                    <?= $alumno['id'] == $derivacion['alumno_id'] ? 'selected' : '' ?>>
                        ...
                        <div class="textarea-wrapper mt-3">
                            ...
                            <textarea name="motivo" class="auto-expand-textarea"
                                placeholder="Detalle el motivo de la derivación..." maxlength="500"
                                required><?= esc($derivacion['motivo']) ?></textarea>
                            <div class="character-count">
                                <?= strlen($derivacion['motivo']) ?>/500
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label">Urgencia <span class="required-mark">*</span></label>
                                    <div>
                                        <label>
                                            <input type="radio" name="urgencia" value="BAJA"
                                                <?= $derivacion['urgencia'] === 'BAJA' ? 'checked' : '' ?>> Baja
                                        </label>
                                        <label>
                                            <input type="radio" name="urgencia" value="MEDIA"
                                                <?= $derivacion['urgencia'] === 'MEDIA' ? 'checked' : '' ?>> Media
                                        </label>
                                        <label>
                                            <input type="radio" name="urgencia" value="ALTA"
                                                <?= $derivacion['urgencia'] === 'ALTA' ? 'checked' : '' ?>> Alta
                                        </label>
                                    </div>
                                </div>
                            </div>
